...
async function addMetaTitleColumn() {
  ...
  try {
    ...
    console.log('✅ metaTitle kolonu başarıyla eklendi');
    ...
    if (columns.length > 0) {
      console.log('✅ metaTitle kolonu doğrulandı');
    } else {
      console.log('❌ metaTitle kolonu eklenemedi');
    }

  } catch (error) {
    if (error.message.includes('Duplicate column name')) {
      console.log('✅ metaTitle kolonu zaten mevcut');
    } else {
