...
// Modern Hero Bileşeni
function ModernHero() {
  return (
    <section className="relative min-h-[450px] bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 overflow-hidden">
      {/* Arka plan efektleri */}
      ...
      <div className="absolute bottom-1/4 left-1/4 w-72 h-72 bg-blue-600/20 rounded-full filter blur-3xl animate-pulse delay-1000"></div>
      ...
      <div className="relative max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="text-center text-white">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center mb-12">
            <a 
              href="/products" 
              className="group inline-flex items-center justify-center px-8 py-4 bg-gradient-to-r from-purple-600 to-pink-600 text-white font-semibold rounded-2xl hover:from-purple-700 hover:to-pink-700 transition-all duration-300 transform hover:scale-105 shadow-lg hover:shadow-xl"
            >
              Koleksiyonu Keşfet
